...
<html>
    ...
    <center>
        ...
        <table style="width: 35%" class="table table-condensed"> 
            <form modelAttribute="user" action="updateAccount.htm" enctype="multipart/form-data" method="POST">
                <tr>
                    <th>
                        Username: 
                    </th>
                    <td>
                        <input type="text" name="username" value="${user1.getUsername()}" readonly="${RO}"/>
                    </td>    
                </tr>
                <tr>
                    <th> 
                    ...
                    <td>
                        <input type="password" name="password" value="${user1.getPassword()}"/>
                    </td>    
                </tr>
                <tr>
                    <th> 
                    ...
                    <td>
                        <input type="text" name="fullname" value="${user1.getFullname()}"/>
                    </td>    
                </tr>
                <tr>
                    <th> 
                ...
                <tr>
                    ...
                    <td>
                        <img src="images/${user1.getImg()}" width="200px" height="200px"/>
                    </td>    
                </tr>
                <tr>

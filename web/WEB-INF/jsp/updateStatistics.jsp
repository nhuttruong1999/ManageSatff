...
<html>
    ...
    <center>
        ...
        <table style="width: 35%" class="table table-condensed"> 
            <form action="updateStatistics.htm" modelAttribute="statistics" method="POST">
                <tr>
                    <th>
                        Record-ID:
                    </th>
...
<!--                        <textarea rows="5" class="form-control" name="Reason" value="${statistics1.getReason()}" placeholder="Message"></textarea>-->
                    </td>    
                </tr>
                <tr>
